...
| **simulate-agent** | Run multi-turn agent simulations with defined user personas using evaluatorq — drive an agent under test, control max turns and stop conditions, store transcripts as orq.ai threads | [SKILL.md](skills/simulate-agent/SKILL.md) |
<!-- END_SKILLS_TABLE -->
